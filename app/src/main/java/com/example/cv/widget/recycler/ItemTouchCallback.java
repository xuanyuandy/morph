...
import com.example.cv.event.ItemDragEvent;

import org.greenrobot.eventbus.EventBus;

public class ItemTouchCallback extends ItemTouchHelper.Callback {

    private com.example.cv.widget.recycler.MovableAdapter mAdapter;
    private boolean mInteractionOver;

    public ItemTouchCallback(com.example.cv.widget.recycler.MovableAdapter adapter) {
        mAdapter = adapter;
    }
